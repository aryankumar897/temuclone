...
export const fetchVariantsByProduct = createAsyncThunk(
  "vendorsvariants/fetchByProduct",
  async (productId) => {
    try {
      const res = await fetch(
        `${process.env.API}/vendors/variants/product/${productId}`
      );
...
export const createVariants = createAsyncThunk(
  "vendorsvariants/create",
  async ({ productId, variants }, { rejectWithValue }) => {
    try {
      const res = await fetch(`${process.env.API}/vendors/variants`, {
        method: "POST",
        headers: {
...
export const updateVariant = createAsyncThunk(
  "vendorsvariants/update",
  async ({ id, variantData }) => {
    try {
      const res = await fetch(
        `${process.env.API}/vendors/variants/${id}`,
        {
          method: "PUT",
