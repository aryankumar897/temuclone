...
import { fetchProductById, updateProduct } from "@/slice/vendorSlice";

import ProductForm from "@/components/dashboard/vendor/Products/Create/ProductForm";
import ProductSidebar from "@/components/dashboard/vendor/Products/Create/ProductSidebar";
...
export default function EditProductPage() {
  ...
  const { current, loading } = useSelector((state) => state.vendors);
  ...
  const handleUpdate = async (payload) => {
    try {
      ...
      router.push("/dashboard/vendor/products/list");
    } catch (err) {
