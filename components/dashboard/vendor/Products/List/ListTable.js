...
import { fetchProducts, deleteProduct } from "@/slice/vendorSlice";
...
export default function ProductTable() {
  ...
  const handleEdit = (id) => {
    router.push(`/dashboard/vendor/products/edit?id=${id}`);
  };
            ...
            <AccordionDetails>
              ...
              >
                ...
                <IconButton
                  onClick={() =>
                    router.push(
                      `/dashboard/vendor/products/variants?id=${row._id}`,
                    )
                  }
                  sx={{ color: "#b626f4" }}
                >
